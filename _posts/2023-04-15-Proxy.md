...
This plugin creates a proxy for a folder. Whatever was in the folder is exported
...
Another benefit is to protect the contents of the folder. If you are happy with

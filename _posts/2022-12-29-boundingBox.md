...
If nothing is selected but a mask is active, then it bounding boxes the mask.
If nothing is selected but a layer with a mask is active, then it bounding boxes the mask.
If nothing is selected but a layer with alpha is active, then it bounding boxes the alpha.

*A function to select a bounding box*

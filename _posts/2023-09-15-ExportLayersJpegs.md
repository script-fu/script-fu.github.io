...
To download [**layer-export-jpeg.scm**](https://raw.githubusercontent.com/script-fu/script-fu.github.io/main/plug-ins/layer-export-jpeg/layer-export-jpeg.scm)  
...follow the link, right click the page, Save as layer-export-jpeg.scm, in a folder called layer-export-jpeg, in a GIMP plug-ins location.  
In Linux, set the file to be executable.
   
<!-- include-plugin "layer-export-jpeg" -->
```scheme

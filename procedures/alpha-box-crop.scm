; crops layer list to the alpha area, plus a safe border
; (image, list of layers, border width)
(define (alpha-box-crop img drwbls expand)
  (let*
    (
      (actL 0)(pnts 0)(alphaSel 0)(wdth 0)(hgt 0)(offX 0)(offY 0)(i 0)
    ...
    (while (< i (vector-length drwbls))
      ...
      (set! alphaSel (gimp-image-select-item img CHANNEL-OP-REPLACE actL))
